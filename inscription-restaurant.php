                ...
                <div class="inscription-undertitle">
                    ...
                    <section class="container-inscrirestau">
                        <section class="section-inscrirestau1">
                            ...
                            <div class="questionnaire">
                            <input id="hero-search-bar" type="search" placeholder="Entrez votre numéro de téléphone portable">
                            </div>
                        </section>
                            <section class="section-inscrirestau2">
                            <div class="questionnaire">
                                <input id="hero-search-bar" type="search" placeholder="Entrez le nom de votre établissement">
                            </div>
                            <div class="questionnaire">
                                <input id="hero-search-bar" type="search" placeholder="Entrez l'adresse de votre établissement">
                            </div>
                            <div class="questionnaire">
